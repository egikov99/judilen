...
describe("ClientNotesManager", () => {
  it("renders note list and disables submit when text is empty", () => {
    render(createElement(ClientNotesManager, {
      clientId: "test-client",
      initialNotes: [{ id: "note-1", text: "Проверка", authorName: "Админ", createdAt: "2026-07-08T10:00:00.000Z", updatedAt: "2026-07-08T10:00:00.000Z" }],
      canWrite: true
    }));
