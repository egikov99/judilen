...
export function QuickBookingForm({ houses, defaults }: {
  ...
  return <section className="panel" style={{ marginBottom: 20 }}><h2>Новое бронирование</h2>{message && <p className="notice">{message}</p>}<form className="form-stack" onSubmit={submit}>
